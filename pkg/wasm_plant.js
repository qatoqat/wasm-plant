...
export function start_animation_loop() {
    const ret = wasm.start_animation_loop();
    if (ret[1]) {
...
export function draw_frame() {
    const ret = wasm.draw_frame();
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
...
function __wbg_adapter_20(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h30cf5343be86e097(arg0, arg1);
}
...
function __wbg_get_imports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_alert_b1b6e419e01796a3 = function(arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('wasm_plant_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
